#ifndef pfIsoCalculatorMuTree_h
#define pfIsoCalculatorMuTree_h
...
class pfIsoCalculatorMuTree
{

 public:

  pfIsoCalculatorMuTree(const edm::Event &iEvent, const edm::EventSetup &iSetup, const edm::InputTag &pfCandidateLabel_, const edm::InputTag &pfVoroniBkgLabel_, const edm::InputTag &vtxLabel_) ;
  pfIsoCalculatorMuTree(const edm::Event &iEvent, const edm::EventSetup &iSetup, const edm::EDGetTokenT<edm::View<reco::PFCandidate> > pfCandidates, const edm::EDGetTokenT<edm::ValueMap<reco::VoronoiBackground> > pfVoronoiBkg, const math::XYZPoint& pv) ;
