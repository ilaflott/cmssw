...
pfIsoCalculatorMuTree::pfIsoCalculatorMuTree(const edm::Event &iEvent, const edm::EventSetup &iSetup, const edm::InputTag &pfCandidateLabel_, const edm::InputTag &pfVoroniBkgLabel_,  const edm::InputTag &vtxLabel_ )
{
...
pfIsoCalculatorMuTree::pfIsoCalculatorMuTree(const edm::Event &iEvent, const edm::EventSetup &iSetup, const edm::EDGetTokenT<edm::View<reco::PFCandidate> > pfCandidates_, const edm::EDGetTokenT<edm::ValueMap<reco::VoronoiBackground> > pfVoronoiBkg_, const math::XYZPoint& pv)
{
...
double pfIsoCalculatorMuTree::getPfIso(const reco::Photon& photon, int pfId, double r1, double r2, double jWidth, double threshold)
{
  using namespace edm;
  using namespace reco;
...
double pfIsoCalculatorMuTree::getVsPfIso(const reco::Photon& photon, int pfId, double r1, double r2, double jWidth, double threshold, bool isVsCorrected)
{
  using namespace edm;
  using namespace reco;
...
double pfIsoCalculatorMuTree::getPfIso(const reco::GsfElectron& ele, int pfId, double r1, double r2, double threshold)
{
