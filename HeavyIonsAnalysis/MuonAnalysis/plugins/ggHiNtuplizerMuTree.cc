...
void ggHiNtuplizerMuTree::fillElectrons(const edm::Event& e, const edm::EventSetup& es, math::XYZPoint& pv)
{
...
void ggHiNtuplizerMuTree::fillPhotons(const edm::Event& e, const edm::EventSetup& es, math::XYZPoint& pv)
{
