...
GenParticleParentageMuTree::
GenParticleParentageMuTree(reco::GenParticleRef& _match) {
...
void GenParticleParentageMuTree::getParentageRecursive(const reco::GenParticleRef& p, int daughterId) {
  // stopping condition
...
void GenParticleParentageMuTree::resolveParentage() {
...
bool GenParticleParentageMuTree::hasAsParent(const reco::GenParticleRef& d,
